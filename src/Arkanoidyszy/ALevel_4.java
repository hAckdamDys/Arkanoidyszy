...
public class ALevel_4 extends ALevel{
    ...
    protected void makeGrid(){
        ...
        */
        ...
        for (int i = 0; i < 49; i++) {
            bricks[i] = new Brick(list2.get((int)(Math.random()*2)), Brick.BRICKSIZEWIDTH * (int)(list.get(i)/7), Brick.BRICKSIZEHEIGHT * (int)(list.get(i)%7),(int)(Math.random()*7),500, PowerupEffectKind.values()[new Random().nextInt(PowerupEffectKind.values().length)]);
        }
